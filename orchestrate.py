...
LAUNCHD_JOBS = [
    {"label": "com.local.wake-scheduler", "kind": "daemon",
     ...
     "desc": "Re-applies the pmset wake alarm at boot and 4:55 AM"},
    {"label": "com.local.post-wake", "kind": "daemon",
     "plist": "/Library/LaunchDaemons/com.local.post-wake.plist",
     "desc": "Post-wake: SSH check, IP log"},
    {"label": "com.user.caffeinate", "kind": "agent",
     "plist": str(Path.home() / "Library/LaunchAgents/com.user.caffeinate.plist"),
     "desc": "Prevents idle sleep while logged in"},
