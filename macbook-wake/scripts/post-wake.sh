#!/bin/bash
# post-wake.sh
# Runs at 5:00am via LaunchAgent (fires after wake due to StartCalendarInterval).
# Ensures the Mac is ready for remote access via SSH, Claude, Terminus, etc.
...
log "Asserting caffeinate for 4 hours..."
caffeinate -s -t 14400 &
CAFE_PID=$!
